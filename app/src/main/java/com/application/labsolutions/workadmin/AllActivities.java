...
public class AllActivities extends AppCompatActivity {
                            ...
                            if (ds.hasChildren()) {
                                ...
                                for (DataSnapshot activitiesDs : ds.getChildren()) {
                                    if (activitiesDs.child("customer-info").getValue() != null) {
                                        String activityId = activitiesDs.getKey();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case 1:
                Intent intentAdminActivity = new Intent(AllActivities.this, WorkadminActivity.class);
                finishAffinity();
                startActivity(intentAdminActivity);
                return true;
            case 2:
                Intent intentInstruments = new Intent(AllActivities.this, WorkAdminInstruments.class);
                finishAffinity();
                startActivity(intentInstruments);
                return true;
            case 3:
                Intent intentCurrentActivities = new Intent(AllActivities.this, WorkAdminAssignActivity.class);
                finishAffinity();
