    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case 7:
                ...
                return true;
            case 8:
                Intent intentLeaves = new Intent(UpdateLeaves.this, AllUpcomingLeaves.class);
                finishAffinity();
            ...
            case 9:
                ...
                return true;
            case 10:
                Intent intentDasboard = new Intent(UpdateLeaves.this, Statistics.class);
                finishAffinity();
                startActivity(intentDasboard);
                return true;
            case 11:
                Intent intentAdminDashboard = new Intent(UpdateLeaves.this, Dashboard.class);
                finishAffinity();
