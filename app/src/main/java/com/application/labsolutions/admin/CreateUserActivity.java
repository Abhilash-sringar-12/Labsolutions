    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case 7:
                ...
                return true;
            case 8:
                Intent intentLeaves = new Intent(CreateUserActivity.this, AllUpcomingLeaves.class);
                finishAffinity();
            ...
            case 9:
                ...
                return true;
            case 10:
                Intent intentDasboard = new Intent(CreateUserActivity.this, Statistics.class);
                finishAffinity();
                startActivity(intentDasboard);
                return true;
            case 11:
                Intent intentAdminDashboard = new Intent(CreateUserActivity.this, Dashboard.class);
                finishAffinity();
