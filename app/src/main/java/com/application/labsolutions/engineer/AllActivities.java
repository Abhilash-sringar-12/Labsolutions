...
public class AllActivities extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case 1:
                Intent intentAdminActivity = new Intent(AllActivities.this, AssignedActivities.class);
                finishAffinity();
                startActivity(intentAdminActivity);
                return true;
            case 2:
                Intent intentInstruments = new Intent(AllActivities.this, AllActivities.class);
                finishAffinity();
                startActivity(intentInstruments);
                return true;
            case 3:
                Intent intentAttendance = new Intent(AllActivities.this, Attendance.class);
                finishAffinity();
                startActivity(intentAttendance);
                return true;
            case 4:
                Intent intentApplyLeave = new Intent(AllActivities.this, ApplyLeave.class);
                finishAffinity();
                startActivity(intentApplyLeave);
                return true;
            case 5:
                Intent intentYourLeaves = new Intent(AllActivities.this, AppliedLeaves.class);
                finishAffinity();
                startActivity(intentYourLeaves);
                return true;
            case 6:
                Intent intentYourStats = new Intent(AllActivities.this, YourStaticstics.class);
                finishAffinity();
