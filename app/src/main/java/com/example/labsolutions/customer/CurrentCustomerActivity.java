...
public class CurrentCustomerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            ...
            if (FirebaseAuth.getInstance().getCurrentUser() != null) {
                ...
                progressDialog = ProgressDialog.show(CurrentCustomerActivity.this, "Please wait", "Loading your current activities.....", true, false);
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot activitiesDs) {
                                            try {
                                                if (activitiesDs.hasChildren()) {
                                                    ...
                                                    setRecycleItems(CurrentCustomerActivity.this, activitiesList, searchView, listview, "info");
                                                } else {
                                                    Commons.dismissProgressDialog(progressDialog);
                ...
                Intent intent = new Intent(CurrentCustomerActivity.this, MainActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case 1:
                Intent intentAdminActivity = new Intent(CurrentCustomerActivity.this, CustomerActivity.class);
                finishAffinity();
                startActivity(intentAdminActivity);
                return true;
            case 2:
                Intent intentCreateUserActivity = new Intent(CurrentCustomerActivity.this, CurrentCustomerActivity.class);
                finishAffinity();
                startActivity(intentCreateUserActivity);
                return true;
            case 3:
                Intent intentAddInstrument = new Intent(CurrentCustomerActivity.this, AllActivities.class);
                finishAffinity();
            ...
            case 4:
                ...
                Intent intentSignOut = new Intent(CurrentCustomerActivity.this, LoginActivity.class);
                finishAffinity();
